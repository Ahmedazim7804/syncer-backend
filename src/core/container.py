...
class Container(containers.DeclarativeContainer):
    ...
    clipboard_repository = providers.Factory(ClipboardRepository, db_factory=db.provided.session)

    auth_service = providers.Factory(AuthService, auth_repository = auth_repository)
    clipboard_service = providers.Factory(ClipboardService, clipboard_repository = clipboard_repository)